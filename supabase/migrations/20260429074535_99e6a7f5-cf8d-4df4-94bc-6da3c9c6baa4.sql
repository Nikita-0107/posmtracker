CREATE OR REPLACE FUNCTION public.request_movement_correction(_movement_id uuid, _new_qty integer, _reason text)
 RETURNS integer
 LANGUAGE plpgsql
 SECURITY DEFINER
...
BEGIN
  ...
  IF _row.created_at < now() - interval '48 hours' THEN
