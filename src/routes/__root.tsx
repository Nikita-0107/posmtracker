...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "POSM Tracker" },
      { name: "description", content: "Mobile POSM tracking for dispatch, issue, and upload" },
      { property: "og:title", content: "POSM Tracker" },
      { property: "og:description", content: "Mobile POSM tracking for dispatch, issue, and upload" },
