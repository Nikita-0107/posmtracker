...
import { importWdStock } from "@/lib/admin.functions";
...
function WdStockImportPage() {
  ...
  function downloadTemplate() {
    ...
    XLSX.utils.book_append_sheet(wb, ws, "WD_CODE");
    XLSX.writeFile(wb, `wd-stock-template.xlsx`);
    toast.success("Template downloaded — rename the sheet to the WD code, duplicate as needed");
  }
